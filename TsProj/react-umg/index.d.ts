...
export interface DynamicEntryBoxProps extends WidgetProps {
...
export interface PointerToUberGraphFrame {
}

export interface TestHUD_CProps extends UserWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    PB_Percent?: number;
    NotifyJS?: (NewParam1: number) => void;
    OnAdd?: (NewParam: number) => void;
}

export class TestHUD_C extends React.Component<TestHUD_CProps> {}

export interface SKEL_TestHUD_CProps extends UserWidgetProps {
    UberGraphFrame?: PointerToUberGraphFrame;
    PB_Percent?: number;
    NotifyJS?: (NewParam1: number) => void;
    OnAdd?: (NewParam: number) => void;
...
export class SKEL_TestHUD_C extends React.Component<SKEL_TestHUD_CProps> {}
